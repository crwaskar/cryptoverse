...
import CoinDetailsStyle from "./styles/CoinDetailsStyle.css"
            ...
            <div className="btn">
             ...
             <button  onClick={()=>setCurrency('usd')}>usd </button>
              ...
              <div className="coin-image">
                <img src={coin.image.large} alt="coin"  style={{height:"120px"}}/>
              </div>
              ...
              <IoPulseOutline color="orange" style={{marginRight:"5px"}}/>
